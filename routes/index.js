...
router.get('/', function (req, res) {
  res.render('index', { title: 'Mobiles app', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'Mobiles app Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Mobiles app Login', user: req.user });
});
